...
directory_path = r'C:\Users\Dominik\PycharmProjects\ResultsComparison\reports'
...
for i, metric in enumerate(metrics):
    ...
    plt.savefig(fr'C:\Users\Dominik\PycharmProjects\ResultsComparison\reports\images\plot_{metric}.png', bbox_inches='tight')
